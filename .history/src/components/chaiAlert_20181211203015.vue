         ...
         <div class="con">
            ...
            <div class="btn-1 psd" style="overflow-y: auto;max-height: 300px;">
              <div style="margin-top: 15px;">
                <span>拆单数：</span><input type="number" :placeholder="`总件数 ${splitRequest.goods_num}`" @change="" v-model="num" style="height: 28px;width: 193px;"/>
              </div>
              <div style="margin-top: 15px;border: 1.5px solid #00000024;">
                <div>
                  <span>拆单数：</span><input type="number" :placeholder="`可拆分件数 ${splitRequest.surplusnum}`" v-model="num" style="height: 28px;width: 193px;"/>
                </div>
                <div style="margin-top: 15px;">
                  <span>拆单数：</span><input type="number" :placeholder="`可拆分件数 ${splitRequest.surplusnum}`" v-model="num" style="height: 28px;width: 193px;"/>
                </div>
