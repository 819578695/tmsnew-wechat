<template>
  <div class="tips" style="padding-top:15px;">
         ...
         <div class="con">
            ...
            <div class="btn-1 psd">
              ...
              <div style="margin-top: 15px;">
                <span>确认件数：</span><input type="number" :placeholder="`未扫件数 ${dataRequest.surplusnum}`" v-model="num" style="height: 28px;width: 193px;"/>
              </div>
            </div>
