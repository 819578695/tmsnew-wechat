  ...
  <div class="page">
    ...
    <van-row>
      <ul waterfall-disabled="disabled"
          ...
          class="tBody">
          <li>
          <van-col span="5" align="center">fas</van-col>
          <van-col span="4" align="center">fdsaf</van-col>
          <van-col span="5" align="center">gfdgd</van-col>
          <van-col span="5" align="center">gdfgd</van-col>
          <van-col span="5" align="center">gfdg</van-col>
        </li>
