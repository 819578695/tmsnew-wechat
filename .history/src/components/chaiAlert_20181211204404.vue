         ...
         <div class="con">
            ...
            <div class="btn-1 psd" style="overflow-y: auto;max-height: 300px;">
              ...
              <div style="margin-top: 15px;border: 1.5px solid #00000024;" v-for="(val,index) in num" :key="index">
                ...
                <div>
                  <span>件数：</span><input type="number" :placeholder="`可拆分件数 ${splitRequest.surplusnum}`" style="height: 28px;width: 193px;"/>
                </div>
                <div style="margin-top: 15px;">
                  <span>重量</span><input type="number" :placeholder="`可拆分件数 ${splitRequest.surplusnum}`" style="height: 28px;width: 193px;"/>
                </div>
              </div>
            </div>
