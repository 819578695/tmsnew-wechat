<template>
  <div class="page">
    ...
    <van-cell-group class="data">
      <van-cell title="订单号" :value="data.box_no" />
      <van-cell title="是否特殊物品" :value="data.box_no" />
      <van-cell title="重量" value=""/>
      <van-cell title="体积" value=""/>
      <van-cell title="是否取件" value=""/>
      <van-cell title="现金现付" value=""/>
      <van-cell title="油卡现付" value=""/>
      <van-cell title="到付" value=""/> 
      <van-cell title="欠付" value=""/>
      <van-cell title="提货费" value=""/>
      <van-cell title="干线运输费" value=""/>
      <van-cell title="送货费" value=""/>
      <van-cell title="其他费用" value=""/>
