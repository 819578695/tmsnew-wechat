  ...
  <div class="page">
    ...
    <van-cell-group class="data">
      ...
      <van-cell title="收件地址" :value="data.is_special" />
          <div class="page1">
    <van-row class="tHead">
      <van-col span="3" align="center">商品名称</van-col>
      <van-col span="3" align="center">数量</van-col>
      <van-col span="4" align="center">体积</van-col>
      <van-col span="4" align="center">重量</van-col>
      <van-col span="4" align="center">备注</van-col>
    ...
    <van-row>
      <ul waterfall-disabled="disabled"
          ...
          class="tBody">
        <li v-for="(val,index) in data.products" :key="index">
          <van-col span="3" align="center">{{val.name}}</van-col>
          <van-col span="3" align="center">{{val.number}}</van-col>
          <van-col span="4" align="center">{{val.volume}}</van-col>
          <van-col span="4" align="center">{{val.weight}}</van-col>
          <van-col span="4" align="center">{{val.remark}}</van-col>
        </li>
      </ul>
    </van-row>
  </div>
