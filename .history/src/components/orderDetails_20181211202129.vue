    ...
    <van-row>
      <ul waterfall-disabled="disabled" waterfall-offset="200" class="tBody">
        <li v-for="(val,index) in orderData" :key="index">
          ...
          <van-col span="4" align="center"><img src="../assets/images/chai.png" style="width:25px;height: 20px;" @click="splitOrder(val.order_no)"/></van-col>
...
export default {
  ...
  methods: {
    ...
    splitOrder(){
        this.tips={ title: '提示', content: data, show: true};
    }
  }
};
</script>
