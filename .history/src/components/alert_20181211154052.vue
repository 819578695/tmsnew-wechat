         ...
         <div class="con">
            ...
            <div class="btn-1 psd">
              ...
              <div style="margin-top: 15px;">
                <span>确认件数：</span><input type="number" :placeholder="`总件数${dataRequest.goods_num}`" v-model="num" style="border:0.5px solid #378888;height: 28px;width: 193px;"/>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    confirm () {
      this.$emit("check",this.num,dataRequest.product_no);
    },
    showPassword() {
      /* 密码显示 */
      if (this.eye) {
