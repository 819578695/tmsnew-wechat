...
export default {
  ...
  created(){
    ...
    window.getToAddress = (address='') => {
      if(null!=address){
          alert(address);
          var index=address.indexOf('barcode');
          var index2=address.indexOf('barcode :');
          var index3=address.indexOf(': O');
          var index4=address.indexOf('O');
          alert(index);
          alert(index2);
          alert(index3);
          alert(index4);
          ...
          alert(last);
          var barcode=last.substr(0,address.indexOf('bar'));
          alert(barcode);
