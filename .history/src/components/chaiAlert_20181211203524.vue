    ...
    ></tips>
         <div class="con">
            ...
            <div class="btn-1 psd" style="overflow-y: auto;max-height: 300px;">
              ...
              <div style="margin-top: 15px;border: 1.5px solid #00000024;" v-for="(val,index) in orderDatas" :key="index">
                <div>
...
export default {
  ...
  methods: {
    ...
    changesOrder(){
      orderDatas.number=this.splitRequest.goods_num/this.this.num;
      orderDatas.weight=this.splitRequest.weight/this.this.num;
    }
  }
};
</script>
