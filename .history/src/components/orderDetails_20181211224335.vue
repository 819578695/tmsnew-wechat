    ...
    <van-row>
      <ul waterfall-disabled="disabled" waterfall-offset="200" class="tBody">
        <li v-for="(val,index) in orderData" :key="index">
          ...
          <van-col span="4" align="center"><img src="../assets/images/chai.png" style="width:25px;height: 20px;" @click="splitOrder(val.order_no,val.goods_num,val.weight)"/></van-col>
...
export default {
  ...
  methods: {
    ...
    splitOrder(order_no,goods_num,weight){
      //如果已经扫码完成，将不能拆分订单
      if(goods_num==this.dataRequest.barcode_num){
