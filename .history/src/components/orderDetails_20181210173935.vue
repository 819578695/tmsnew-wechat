<template>
  <div class="page1" style="margin-top: -96px;">
    ...
    <van-row class="tHead">
      ...
      <van-col span="6" align="center">总件数</van-col>
      <van-col span="6" align="center">已扫描件数</van-col>
    ...
    <van-row>
      <ul waterfall-disabled="disabled" waterfall-offset="200" class="tBody">
        <li v-for="(val,index) in orderData" :key="index">
          ...
          <van-col span="6" align="center">{{val.goods_num}}</van-col>
          <van-col span="6" align="center">{{val.barcode_num}}</van-col>
          <van-col span="4" align="center"><img src="../assets/images/del.png" style="width:25px;" @click="delCode(val.orderId)"/></van-col>
        </li>
      </ul>
    </van-row>
    <!-- <div class="btn-affirm"  @click="toggleCheckPsd" style="margin-top:5rem;">
        详细清晰
    </div> -->
  </div>
</template>
