    ...
    <van-row>
      <ul waterfall-disabled="disabled"
        ...
        <li>
          ...
          <van-col span="3" align="center">{{orderData.consignuser}}</van-col>
          <van-col span="4" align="center">{{orderData.recipientuser}}</van-col>
          <van-col span="4" align="center">{{orderData.removeNum}}</van-col>
          <van-col span="4" align="center">{{orderData.receive_amoount}}</van-col>
