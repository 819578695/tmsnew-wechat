         ...
         <div class="con">
            ...
            <div class="btn-1 psd" style="overflow-y: auto;max-height: 260px;">
              <div style="margin-top: 15px;">
                <span>拒收件数：</span><input type="number" :placeholder="`总件数 ${splitRequest.goods_num}`" @change="changesOrder" @keyup="changesOrder" v-model="num" style="height: 28px;width: 193px;"/>
              </div>
            </div>
