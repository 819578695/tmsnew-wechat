<template>
  <div ref="container" class="vue-pull-refresh">
    <div v-bind:class="{'vue-pull-refresh-msg1':flag==0,'vue-pull-refresh-msg':flag==1}">
      <template v-if="loading">
        <svg t="1497367491334"
          viewBox="0 0 1024 1024"
          class="vue-pull-refresh-loading"
          style="width: 1.2em; height: 3em;vertical-align: middle;fill: currentColor;overflow: hidden;display:none" 
      ...
      <template v-else>
        <svg t="1497366759944" 
             ...
             style="width: 1rem; height: 2rem; vertical-align: middle;fill: currentColor;overflow: hidden;"
