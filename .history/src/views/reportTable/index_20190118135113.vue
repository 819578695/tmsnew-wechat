      ...
      <van-row style="padding-top:25px;" v-show="type==1">
        ...
        >
          ...
          <div style="width:100%;height: 55px;">
            ...
            >{{item.license}}</span>
            <div
              style="width: 28%;float: right;line-height: 51px;line-height: 51px;margin-right: 25px;background-color: red;margin-top: -15px;color:#fff;border-radius: 6px;"
            >{{item.bname}}</div>
          </div>
