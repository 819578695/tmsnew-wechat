...
export default {
  ...
  methods: {
    ...
    submit(){
      var this_=this;
       this.utils.request.signOrderExce({t:'execOrder',order_id:this.orderid,images:this.imgUrl.join(","),reason:this.type,remark:'拒收数量：'+this.num,totalCount:this.totalCount,num:this.num},function(data) {
