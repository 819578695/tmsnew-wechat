      ...
      <van-row v-show="type==1" id="rows">
        <div style="height:600px;width:95%;margin-bottom:15px;box-shadow:rgba(0, 0, 0, 0.1) 0px 1px 1px 1px;">
          ...
          <div style="font-size: 14px;width:90%;height: 30px;">
            <button style="float: right;border:none;height: 30px;width: 80px;font-size: 13px;box-shadow:2px 4px 6px rgba(0, 0, 0, 0.3);border-radius: 6px;">确认收货</button>
            <button style="float: right;border:none;height: 30px;width: 80px;font-size: 13px;box-shadow:2px 4px 6px rgba(0, 0, 0, 0.3);border-radius: 6px;">拒收</button>
          </div>
        </div>
      </van-row>
      </div>
