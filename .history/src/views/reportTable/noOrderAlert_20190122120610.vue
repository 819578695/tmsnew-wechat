...
export default {
  ...
  methods: {
    ...
    submit(){
      var this_=this;
       this.utils.request.editUserInfo({t:'execOrder',order_id:this.orderid,data:this.imgUrl.join(","),reason:4,remark:252,remark:252,remark:252,remark:252},function(data) {
