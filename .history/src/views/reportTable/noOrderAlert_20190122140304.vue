...
export default {
  ...
  methods: {
    ...
    submit(){
      var this_=this;
      debugger
       this.utils.request.signOrderExce({t:'execOrder',order_id:this.orderid,images:this.imgUrl.join(","),reason:this.type,remark:'拒收数量：'+this.num},function(data) {
         this_.tips={title: '提示',content: "操作成功", show:true};
         ththis_is.$emit("checkChaiOrder");
      });
    }
  }
};
