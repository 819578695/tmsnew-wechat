<template>
  <div>
    <div><img @click="$router.push({name:'orderInfo',query:{id:1}}) style='width:40px;height:40px;float: right;transform: translate(-15px,-44px);' src="../../assets/images/ewm.png"/></div>
