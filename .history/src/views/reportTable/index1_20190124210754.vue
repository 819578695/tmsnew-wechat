<template>
  <div>
    ...
    <div
      align="center"
      style="padding-top:15px;height:50px;box-shadow:2px 4px 6px rgba(0, 0, 0, 0.3);z-index: 9999;  position: fixed;width:100%;opacity:0.5;background-color:rgba(255,0,0,0.5);"
    >
      <van-row>
