    ...
    <div>
      ...
      <van-row v-show="type==1" id="rows">
        <div style="height:600px;width:95%;margin-bottom:15px;box-shadow:rgba(0, 0, 0, 0.2) 0px 2px 3px 2px">
          ...
          <div style="width:85%;height: 30px;text-align: left;"><p>取件地址：李小龙</p></div>
          <div style="width:85%;height: 30px;text-align: left;"><p>发货单位：李小龙</p></div>
          <div style="width:85%;height: 30px;text-align: left;"><p>收件人：李小龙</p></div>
          <div style="width:85%;height: 30px;text-align: left;"><p>收件地址：李小龙</p></div>
          <div style="width:85%;height: 30px;text-align: left;"><p>收件单位：李小龙</p></div>
