<template>
  <div ref="container" class="vue-pull-refresh">
    <div v-bind:class="{'vue-pull-refresh-msg1':loading==0,'vue-pull-refresh-msg':loading}">
      <template v-if="loading">
        <svg t="1497367491334"
          viewBox="0 0 1024 1024"
          class="vue-pull-refresh-loading"
          style="width: 1.2em; height: 1.5em;vertical-align: middle;fill: currentColor;overflow: hidden;display:none" 
