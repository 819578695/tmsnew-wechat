           ...
           <div style="height:200px;width:95%;margin-bottom:15px;box-shadow:rgba(0, 0, 0, 0.1) 0px 1px 1px 1px;">
            ...
            <div style="width:100%;margin-bottom: 35px;padding-top: 15px;">
              <div style="width: 30%;float: left;">
                <span style="color:#333;font-size: 15px;">重量：</span><span style="color:#D9D9D9">2</span><span style="color:#D9D9D9">kg</span>
              </div>
              <div style="width: 30%;float: left;">
                <span style="color:#333;font-size: 15px;">体积：</span><span style="color:#D9D9D9">2</span><span style="color:#D9D9D9">kg</span>
              </div>
              <div style="width: 30%;float: left;">
                <span style="color:#333;font-size: 15px;">数量：</span><span style="color:#D9D9D9">2</span><span style="color:#D9D9D9">kg</span>
              </div>
            </div>
           </div>
