<template>
  <div class="page1">
    ...
    <van-row class="tHead">
      <van-col span="3" align="center">订单类型</van-col>
      <van-col span="3" align="center">箱号</van-col>
      <van-col span="3" align="center">供应商</van-col>
    ...
    <van-row>
      <ul waterfall-disabled="disabled"
        ...
        <li v-for="(val,index) in tableData" :key="index">
          ...
          <van-col span="3" align="center">{{val.company}}</van-col>
          <van-col span="3" align="center">{{val.date}}</van-col>
          <van-col span="4" align="center">{{val.addNum}}</van-col>
          <van-col span="4" align="center">{{val.removeNum}}</van-col>
          <van-col span="4" align="center">{{val.totalNum}}</van-col>
          <van-col span="3" align="center">{{val.totalNum}}</van-col>
        </li>
      </ul>
       <div class="tfoot">
