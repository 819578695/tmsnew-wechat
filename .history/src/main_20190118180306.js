...
axios.interceptors.request.use(function (config){
  // 处理请求之前的配置
var html='<div id="showLoading" align="center" style="margin: auto;position: fixed;top: 0;right:0;bottom: 0;left: 0;z-index: 9999;width: 100%;height: 100%;overflow: hidden;outline: 0; -webkit-overflow-scrolling: touch;background-color: rgb(0, 0, 0);filter: alpha(opacity=60); background-color: rgba(0, 0, 0, 0.6); "><img src="/static/images/loading.gif" style="width:80px;height: 80px;position: absolute;top: 50%;left: 50%;display:none"></div>';
