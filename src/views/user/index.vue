...
export default {
  ...
  mounted(){
    var this_=this;
    this.utils.request.getDriverInfo('',function(data){
      this_.userName=data.name;
    });
  ...
  methods:{
    ...
    updataNames(){
      var this_=this;
      this.utils.request.editDriverName({'name':this.updataName.newName,'pwd':this.updataName.password},function(data){
        this_.$dialog.alert({
          message:'修改成功'
        });
