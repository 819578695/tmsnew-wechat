...
const host='http://tms-api.zgtgroup.com/';
export default {
  request: {
    ...
    //签收异常
    signOrderExce(data,callback){
      this.requestUrl(data, host + 'orderExcep/signOrderExce', callback);
    },
    //根据token获取用户登录信息
    quertUserInfoByToken(data,callback){
      this.requestUrl(data, host + 'cmn/quertUserInfoByToken', callback);
    },
    checkPhoneSystem() {
